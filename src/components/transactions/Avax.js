...
class Avax extends Component {
    ...
    async componentDidMount() {
        ...
        if(this.props.type=="Token"){
            axios.get("https://api.snowtrace.io/api?module=account&action=tokentx&contractaddress="+contractaddress+"&address="+address+"&page=1&offset=100&startblock=0&endblock=2007025780&sort=desc&apikey=VBCFBYV5DZ8I6B4UQSXKIG46S5253ZNB2A")
                .then(res=>{
