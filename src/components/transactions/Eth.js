...
class Eth extends Component {
    ...
    async componentDidMount() {
        ...
        if(this.props.type=="Token"){
            axios.get("https://api.etherscan.io/api?module=account&action=tokentx&contractaddress="+contractaddress+"&address="+address+"&page=1&offset=100&startblock=0&endblock=2007025780&sort=desc&apikey=GY9N4RUU89PUETADPZ8XZ4ZG6SJ6Y4PDE9")
                .then(res=>{
        ...
        if(this.props.type=="Coin"){
            ...
            axios.get("https://api.etherscan.io/api?module=account&action=txlist&address="+address+"&startblock=0&endblock=9999999999&page=1&offset=100&sort=desc&apikey=745FKQE9VDXJIIYU6NEVWQR4NBF7MMNFH6")
                .then(res=>{
                    console.log(res.data.result)
