...
class Fanton extends Component {
    constructor() {
        super();
        this.state={
    ...
    async componentDidMount() {
        ...
        if(this.props.type=="Token"){
            axios.get("https://api.ftmscan.com/api?module=account&action=tokentx&contractaddress="+contractaddress+"&address="+address+"&page=1&offset=100&startblock=0&endblock=2007025780&sort=desc&apikey=CH4EKY3AP752H57IK8B7QVY8GGWWMQY4RH")
                .then(res=>{
