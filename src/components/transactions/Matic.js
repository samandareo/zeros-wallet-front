...
class Matic extends Component {
    ...
    async componentDidMount() {
        ...
        if(this.props.type=="Token"){
            axios.get("https://api.polygonscan.com/api?module=account&action=tokentx&contractaddress="+contractaddress+"&address="+address+"&page=1&offset=100&startblock=0&endblock=2007025780&sort=desc&apikey=JFX22E3QI2CXZG4RJ7I38T9QJICDR8MSJE")
                .then(res=>{
        ...
        if(this.props.type=="Coin"){
            ...
            axios.get("https://api.polygonscan.com/api?module=account&action=txlist&address="+address+"&startblock=0&endblock=9999999999&page=1&offset=100&sort=desc&apikey=2G37P6IFEY7ZAFZX7MCWI5JXD7DWJTWKTN")
                .then(res=>{
                    console.log(res.data.result)
