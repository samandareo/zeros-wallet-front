            ...
            return(
                <div className="crypto-item d-flex align-items-center justify-content-between"
                    ...
                    <div className="text-end">
                        <label className="switch" onClick={this.statusC.bind(this,res.id,res.status=="1"?"0":"1")}>
                            <input type="checkbox" checked={res.status=="1"?true:false}/>
                ...
                <div className="row m-0 "style={{background:"#D0E1F1"}}>
                    ...
                    <div className="col-md-4 col-12 sendlist " style={{paddingTop:"0px"}}>
                        <div className="wallet-header2" style={{background:"#D0E2F1"}}>
                            ...
                            <h3 className="text-center mb-0 " style={{color:"#000000"}}>Manage</h3>
                            <button className="notification-btn">
                                <Link to="/addtoken" style={{textAlign:"right!important"}}>
