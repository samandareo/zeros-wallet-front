...
class WithdrewList extends Component {
    constructor() {
        super();
        this.state={
            token:"",wallet:[],name:""
    ...
    render() {
        ...
        var data = data1.filter((val)=>{
            ...
            return(
                <>
                    <Link to={"/wallet/withdrew/"+res.coin_symbol} style={{textDecoration:"none"}}>
                ...
                <div className="row m-0 "style={{background:"#D0E1F1"}}>
                    ...
                    <div className="col-md-4 col-12 sendlist ">
                        <div className="wallet-header2" style={{background:"#D0E2F1"}}>
                            ...
                            <h3 className="text-center mb-0 " style={{color:"#000000"}}>Withdrew</h3>
